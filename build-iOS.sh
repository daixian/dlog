...
# pip3 install conan
conan create . daixian/stable --profile=./profile/iOS -s build_type=Release -o dlog:shared=True --build missing
conan create . daixian/stable --profile=./profile/iOS -s build_type=Release -o dlog:shared=False --build missing
